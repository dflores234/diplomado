  ...
  <body>
      ...
      <div class="main-section">
  		...
  		<ul class="alternativas">
  			...
  			<li>
  				<label>
  					...
  					Es una tecnologia que permite generar entornos arificiales con el objetivo de simular la presencia del
            usuario en mundos reales o imaginarios
  				</label>
  			</li>
        <li>
          <label>
        ...
        <li>
          <label>
            <input type="radio" name="respuesta1" value="F">
            Es un aparato, por lo general informático, que permite la reproducción de un sistema.
          </label>
        </li>
  		</ul>
  		<div class="pregunta">
  			<span class="numero-pregunta">2.</span>
  			¿Cuales son los 3 aspectos de un sistema virtual?
  		</div>
  		<ul class="alternativas">
        <li>
          <label>
            <input type="radio" name="respuesta2" value="F">
            Simulación,interacción y diversión
          </label>
        </li>
        <li>
          <label>
            <input type="radio" name="respuesta2" value="V">
            Interacción,simulación y percepción
          </label>
        </li>
        <li>
          <label>
            <input type="radio" name="respuesta2" value="F">
            Creación,percepción y innovación
          </label>
        </li>
        <li>
          <label>
            <input type="radio" name="respuesta2" value="F">
            Simulación, percepción y creación
  		...
  		<div class="pregunta">
  			...
  			Elige los 3 tipos de tecnología de tracking:
  		</div>
  		<ul class="alternativas">
  			<li>
  				<label>
