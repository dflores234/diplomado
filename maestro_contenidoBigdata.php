            <div style="width: 200px;margin: 0 auto;">
                      <h1 style="font-size: 25px">
                        <img src="img/data.svg" width="40">Big Data e IoT
                      </h1>
            </div>
                            ...
                            <div class="card-body bg-light">
                                <div class="contanier">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                            <h3>Big data(Ejemplo de éxito Fabricante de trenes)</h3><hr style="background-color: black">
                                                <ul align="left" style="font-size: 14px;">
                            ...
                            <div class="card-body bg-light">
                                <div class="contanier">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                            <h3>Sistemas de adquisición de datos y aplicaciones prácticas</h3><hr style="background-color: black">
                                                <ul align="left" style="font-size: 14px;">
                                                    Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
                                                    tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
                                                    quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
                            ...
                            <div class="card-body bg-light">
                                <div class="contanier">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                            <h3>Gestion de respuesta ante incidentes de ciberseguridad</h3><hr style="background-color: black">
                                                <ul align="left" style="font-size: 14px;">
                                                    Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
                                                    tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
                                                    quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
                            ...
                            <div class="card-body bg-light">
                                <div class="contanier">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                            <h3>Equipos de respuesta ante incidentes</h3><hr style="background-color: black">
                                                <ul align="left" style="font-size: 14px;">
                                                    Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
                                                    tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
                                                    quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
                            ...
                            <div class="card-body bg-light">
                                <div class="contanier">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                            <h3>Introducción General</h3><hr style="background-color: black">
                                                <ul align="left" style="font-size: 14px;">
                                                    Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
                                                    tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
                                                    quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
                            ...
                            <div class="card-body bg-light">
                                <div class="contanier">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                            <h3>Analítica Visual</h3><hr style="background-color: black">
                                                <ul align="left" style="font-size: 14px;">
                                                    Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
                                                    tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
                                                    quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
                            ...
                            <div class="card-body bg-light">
                                <div class="contanier">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                            <h3>Aprendizaje Supervisado</h3><hr style="background-color: black">
                                                <ul align="left" style="font-size: 14px;">
                                                    Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
                                                    tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
                                                    quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
                            ...
                            <div class="card-body bg-light">
                                <div class="contanier">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                            <h3>Entorno Python</h3><hr style="background-color: black">
                                                <ul align="left" style="font-size: 14px;">
                                                    Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
                                                    tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
                                                    quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
                            ...
                            <div class="card-body bg-light">
                                <div class="contanier">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                            <h3>Aprendizaje no supervisado</h3><hr style="background-color: black">
                                                <ul align="left" style="font-size: 14px;">
                                                    Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
                                                    tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
                                                    quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
