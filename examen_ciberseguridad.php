      ...
      <div class="main-section">
        ...
        <li>
  		...
  		<div class="pregunta">
  			...
  			Conjunto de acciones de defensa activas, pasivas, proactivas,preventivas y reactivas para asegurar el uso propio del ciberespacio y negarlo al enemigo
  		</div>
  		<ul class="alternativas">
        <li>
          <label>
        ...
        <li>
  		...
  		<div class="pregunta">
  			...
  			¿La integridad, confidencialidad y disponibilidad son los objetivos principales de la ciberseguridad?
  		</div>
  		<ul class="alternativas">
  			<li>
  				<label>
